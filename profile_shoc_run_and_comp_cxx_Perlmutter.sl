...
make -j8 
make baseline
cd src/physics/shoc/tests
srun ./shoc_run_and_cmp_cxx -g baseline
srun -n 1 nsys profile --stats=true -t nvtx,cuda ./shoc_run_and_comp_cxx >& ../../../../../../../../shoc_run_and_comp_cxx_profile.txt
sed -ie "s/^M//" profile.txt
sed -i '/^$/d' profile.txt
python plot_stats_from_nsight.py shoc_run_and_comp_cxx_profile.txt shoc_run_and_comp_cxx
