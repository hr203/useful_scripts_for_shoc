...
srun -n 1 nsys profile --stats=true -t nvtx,cuda ./shoc_standalone >& ../../../../../../../../shoc_standalone_profile.txt
sed -ie "s/^M//" profile.txt
sed -i '/^$/d' profile.txt
python plot_stats_from_nsight.py shoc_standalone_profile.txt shoc_standalone
